/****************************************************************************
** Meta object code from reading C++ file 'getKeyboard.h'
**
...
#error "The header file 'getKeyboard.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 12, 8), // "killTask"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 6) // "myTask"

    },
    "GetKeyboard\0killTask\0\0myTask"
};
...
void GetKeyboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->killTask(); break;
        case 1: _t->myTask(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GetKeyboard::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GetKeyboard::killTask)) {
                *result = 0;
                return;
            }
        }
