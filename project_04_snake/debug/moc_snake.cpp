...
QT_MOC_LITERAL(1, 6, 15), // "scoreSignalSend"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 5), // "score"
QT_MOC_LITERAL(4, 29, 19), // "timerIntervelSignal"
QT_MOC_LITERAL(5, 49, 5), // "intvl"
...
void Snake::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->scoreSignalSend((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->timerIntervelSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Snake::scoreSignalSend)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Snake::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Snake::timerIntervelSignal)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Snake::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Snake::gameoverSignalSend)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Snake::scoreSignalSend(int _t1)
{
...
// SIGNAL 1
void Snake::timerIntervelSignal(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
