...
QT_MOC_LITERAL(7, 41, 16), // "showDialogSignal"
QT_MOC_LITERAL(8, 58, 7), // "message"
QT_MOC_LITERAL(9, 66, 17), // "mouseClickHandler"
QT_MOC_LITERAL(10, 84, 12) // "resetHandler"

    },
    "Gomoku\0addPieseSignal\0\0objName\0x\0y\0"
    "color\0showDialogSignal\0message\0"
    "mouseClickHandler\0resetHandler"
};
...
void Gomoku::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->showDialogSignal((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->mouseClickHandler((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 3: _t->resetHandler(); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Gomoku::showDialogSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Gomoku::showDialogSignal(QString _t1)
{
